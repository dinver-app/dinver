...
async function generateNaturalReply({
  ...
  try {
    ...
    const system = [
      ...
      '',
      'For what_offers intent (HR):',
      '• "Restoran {name} nudi raznovrsnu ponudu! Iz jelovnika izdvojio bih: {menu_items}. Imaju i odličnu ponudu pića. Restoran je poznat po {food_types} i ima {perks}. Trebate li više informacija o nekom određenom jelu?"',
      '• "Odličan izbor! {name} specijalizira se za {food_types}. Imaju {meal_types} i nude {dietary_options}. Mogu rezervirati stol preko aplikacije. Želite li da vam preporučim nešto konkretno?"',
      '',
      'For what_offers intent (EN):',
      '• "Restaurant {name} offers a diverse menu! From their selection I\'d highlight: {menu_items}. They also have a great drinks selection. The restaurant is known for {food_types} and features {perks}. Would you like more information about any specific dish?"',
      '• "Great choice! {name} specializes in {food_types}. They serve {meal_types} and offer {dietary_options}. You can make reservations through the app. Would you like me to recommend something specific?"',
      '',
      'For combined_search intent:',
      '• First identify which requirements can be met, then respond with restaurants that match multiple criteria',
      '• Example: "Našao sam restorane koji imaju pizzu I vanjsku terasu blizu vas: {restaurants}. Oba nude ono što tražite!"',
      '',
      'For intent "nearby":',
      ...
      '• For perks questions, be specific: "Da, restoran ima vanjsku terasu s 40 mjesta za sjedenje"',
      '• For menu questions, include prices when available: "Pizza Margherita (12 €), Capricciosa (15 €)"',
      '• For dietary options, be clear about limitations: "Restoran ima 3 vegetarijanska jela u ponudi"',
      '• Always suggest next steps: "Trebate li rezervaciju?" or "Želite li kontakt informacije?"',
      '',
      contextualExamples,
      externalExamples,
    ].join('\n');
