...
const TEST_SCENARIOS = [
  {
    ...
    message: 'Ima li restoran koji ima stolice za djecu i pizzu?',
  ...
  },
  {
    ...
    message: 'Gdje da jedem pizzu u Vinkovcima?',
  ...
  },
  {
    ...
    userLocation: 'Vinkovci',
    coords: VINKOVCI_COORDS,
    message: 'Radi li Restoran Marabu sutra i do kad?',
  ...
  },
  {
    ...
    userLocation: 'Vinkovci',
    coords: VINKOVCI_COORDS,
    message: 'Što da jedem u Restoranu Marabu?',
    expectedBehavior: 'Should search menu items and recommendations in restaurant Marabu',
  },
  {
    id: 5,
    userLocation: 'Vinkovci',
    coords: VINKOVCI_COORDS,
    message: 'Ima li restoran Marabu gluten free hranu?',
