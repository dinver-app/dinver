...
module.exports = {
  async query(req, res) {
    try {
      ...
      if (response.menu) results.menu = response.menu;
      if (response.restaurant) results.restaurant = response.restaurant;
      const body = {
        meta,
      ...
      // Uklonjeni generički fallback odgovori – odgovor dolazi iz servisa/NLG-a.
