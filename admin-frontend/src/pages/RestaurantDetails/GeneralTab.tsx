    ...
    <div className="flex flex-col">
      ...
      <div className="border-b border-gray-200 pb-5 mb-6 flex justify-between items-center">
        ...
        <div className="flex items-center">
          ...
          {role !== "helper" && (
            <button onClick={handleSave} className="primary-button px-3 py-1.5">
              {t("save")}
            </button>
          )}
        </div>
      ...
      <div className="space-y-8">
        ...
        <div className="border-b border-gray-200 pb-6">
          ...
          {formData.thumbnailUrl ? (
            ...
            <div
              className={`w-64 h-36 border-2 border-dashed border-gray-300 bg-gray-50 flex flex-col items-center justify-center rounded-md ${
                role !== "helper"
