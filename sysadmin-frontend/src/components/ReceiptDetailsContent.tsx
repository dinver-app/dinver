        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              {/* Tagged Buddies Section */}
              {receipt.taggedBuddies && receipt.taggedBuddies.length > 0 && (
                <div className="bg-white p-4 rounded-lg border border-purple-200 shadow-sm">
                  <div className="flex items-center mb-3">
                    ...
                    <h5 className="text-sm font-medium text-gray-900">
                      Tagged Buddies ({receipt.taggedBuddies.length})
                    </h5>
                  </div>
                  <div className="space-y-2">
                    {receipt.taggedBuddies.map((buddy) => (
                      <div
                        key={buddy.id}
                        className="flex items-center space-x-3 bg-purple-50 px-3 py-2 rounded-lg"
                      >
                        {buddy.profileImage ? (
                          <img
                  ...
                  <div className="mt-3 pt-3 border-t border-purple-100">
                    <p className="text-xs text-purple-700">
                      Bodovi će se podijeliti: {pointsPreview.toFixed(2)} /{" "}
                      {receipt.taggedBuddies.length + 1} ={" "}
                      <strong>
                        {(
                          pointsPreview /
                          (receipt.taggedBuddies.length + 1)
            ...
            <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 p-6">
              ...
              <div className="mb-4">
                ...
                <div className="bg-red-50 border border-red-200 rounded p-3 mb-3">
                  ...
                  <p className="text-xs text-red-600 mt-1">
                    All associated data including images will be permanently
                    deleted.
                  </p>
                </div>
              ...
              <div className="flex justify-end space-x-3">
                ...
                <button
                  ...
                  disabled={
                    deleteConfirmText !== `#${receipt.id.substring(0, 8)}`
                  }
