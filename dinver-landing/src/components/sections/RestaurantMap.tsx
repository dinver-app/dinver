...
const fallbackRestaurants: Partner[] = [
  ...
  },
  {
    id: "6",
    name: "Takenoko",
    address: "Nova Ves 88, Zagreb",
    place: "Zagreb",
    slug: "takenoko",
    dinverRating: 9.3,
    dinverReviewsCount: 267,
    latitude: 45.817,
    longitude: 15.969,
    foodTypes: ["Japanese"],
    isClaimed: true,
...
export default function RestaurantMap({
  ...
  const getMapCenter = useCallback((): [number, number] => {
    ...
    const avgLat =
      validRestaurants.reduce((sum, r) => sum + (r.latitude || 0), 0) /
      validRestaurants.length;
    const avgLng =
      validRestaurants.reduce((sum, r) => sum + (r.longitude || 0), 0) /
      validRestaurants.length;
                    ...
                    <Popup>
                      <div className="p-1">
                        ...
                        <p className="text-sm text-gray-500">
                          {restaurant.foodTypes?.[0] || restaurant.place}
                        </p>
                        {getDisplayRating(restaurant) && (
                          <div className="flex items-center gap-1 mt-1">
                            <Star
                              className="text-dinver-green"
                              size={14}
                              fill="#1E3329"
                            />
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-500">
                    {locale === "hr" ? "Učitavanje karte..." : "Loading map..."}
                  </p>
                </div>
              </div>
            )}
