...
export default function ONama() {
  ...
  const values = [
    {
      icon: Heart,
      title: 'Autentičnost',
      description: 'Vjerujemo u prava iskustva od pravih ljudi. Bez lažnih recenzija, samo iskrene preporuke.',
    },
    {
      icon: Users,
      title: 'Zajednica',
      description: 'Gradimo zajednicu ljubitelja hrane koji dijele strast prema otkrivanju novih gastro doživljaja.',
    },
    {
      icon: Target,
      title: 'Kvaliteta',
      description: 'Surađujemo samo s restoranima koji dijele našu strast prema kvaliteti i izvrsnosti.',
    },
  ];
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <section className="pt-24 pb-16 bg-gradient-to-b from-dinver-dark to-dinver-green-dark text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Dinver je platforma koja povezuje ljubitelje hrane s najboljim gastronomskim
              iskustvima u Hrvatskoj.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Naša priča</h2>
            <div className="prose prose-gray max-w-none text-gray-600 space-y-4">
              <p>
                Dinver je nastao iz jednostavne ideje: olakšati ljudima pronalazak njihovog
                sljedećeg omiljenog restorana. U svijetu prepunom generickih recenzija i
                plaćenih preporuka, željeli smo stvoriti mjesto gdje prava iskustva dolaze
                od pravih ljudi.
              </p>
              <p>
                Naša platforma kombinira društvenu mrežu s vodičem za restorane,
                omogućujući korisnicima da prate prijatelje, dijele svoje gastro trenutke
                i otkrivaju skrivene dragulje koje ne biste pronašli drugdje.
              </p>
              <p>
                Danas Dinver okuplja zajednicu strastvenih ljubitelja hrane koji aktivno
                istražuju, dijele i nagrađuju se za svaki novi gastro doživljaj.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Povezati svakog ljubitelja hrane s autentičnim gastronomskim iskustvima
              i pomoći restoranima da dopru do pravih gostiju.
            </p>
          </motion.div>
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Što nudimo</h2>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Za restorane</h3>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-dinver-dark/70 mb-6">
              Bilo da ste restoran koji želi postati partner ili imate bilo kakvo pitanje,
